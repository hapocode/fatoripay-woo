 ...
 */
var copyToClipboardButton = document.querySelector('.woocommerce-order-details__fatoripay-pix-button');

if (null !== copyToClipboardButton) {
  var payloadCode = document.querySelector('.woocommerce-order-details__fatoripay-pix-payload');
...
external_jQuery_default()(document).on('ready updated_checkout', function () {
  var inputs = document.querySelectorAll('.payment_method_fatoripay-credit-card input.input-text');
...
external_jQuery_default()(document).ajaxComplete(function () {
  var creditCardOptions = external_jQuery_default()('[name="fatoripay_cc_options"]');

  if (0 !== creditCardOptions.length) {
    var ccFormWrapper = external_jQuery_default()('.one-click-buy-option .fatoripay-cc-form-wrapper');
