...
namespace WC_FatoriPay\Log;

use WC_FatoriPay\Gateway\Gateway;

/**
 * Log FatoriPay interation with API and webhook
 */
class Logger {
	...
	public function source() {
		return 'fatoripay-' . $this->gateway->get_type()->get_slug();
	}
	...
	public function log( $message, $level = 'info' ) {
		...
		$message = apply_filters( 'woocommerce_fatoripay_log_message', preg_replace( '/\s+/', ' ', $message ) );
