...
namespace WC_FatoriPay\Cron;

use Exception;
use WC_FatoriPay\Billing_Type\Pix;
...
class Expired_Pix_Cron {
	...
	public function schedule_remove_expired_pix( $order_id ) {
		$pix                = new \WC_FatoriPay\Gateway\Pix();
		...
		wp_schedule_single_event( $run_event, 'remove_expired_pix_fatoripay', array( $wc_order ) );
	}
