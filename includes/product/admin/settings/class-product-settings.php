...
namespace WC_FatoriPay\Product\Admin\Settings;
...
class Product_Settings {
	...
	/**
	 * Shows tip with FatoriPay gateway supported billing cycles
	 */
		...
		<div class="options_group show_if_subscription hidden subscription_pricing">
			<p>
				...
				<strong>
					...
					echo esc_html( sprintf( __( 'FatoriPay gateway currently supports the following billing cycles: %s.', 'fatoripay-woo' ), $subscriptions_helper->get_supported_billing_periods_string() ) );
					?>
				</strong>
			</p>
		</div>
