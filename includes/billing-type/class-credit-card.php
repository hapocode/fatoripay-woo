...
class Credit_Card extends Billing_Type {
	...
	public function get_name() {
		return __( 'Credit Card', 'fatoripay-woo' );
	}
	...
	public function brands() {
		return apply_filters(
			'woocommerce_fatoripay_cc_available_brands', array(
				'visa'       => array(
					'name'                     => __( 'Visa', 'fatoripay-woo' ),
					'number_validation'        => '/^4\d{12}(\d{3})?$/',
					'security_code_validation' => '/^[0-9]{3}$/',
				),
				'mastercard' => array(
					'name'                     => __( 'Mastercard', 'fatoripay-woo' ),
				...
				'discover'   => array(
					'name'                     => __( 'Discover', 'fatoripay-woo' ),
					'number_validation'        => '/^6(?:011|5[0-9]{2})\d{12}$/',
					'security_code_validation' => '/^[0-9]{3}$/',
				),
				'hipercard'  => array(
					'name'                     => __( 'Hipercard', 'fatoripay-woo' ),
