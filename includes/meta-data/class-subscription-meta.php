<?php
/**
 * Abastract WC_Order for FatoriPay subscriptions features.
 *
 * @package FatoriPayWoo
 */

namespace WC_FatoriPay\Meta_Data;

/**
 * Abastract WC_Order for FatoriPay subscriptinos features.
 */
class Subscription_Meta {
	 ...
	 * @var string
	 */
	const META_KEY_SUBSCRIPTION_ID = '_fatoripay_subscription_id';
	 ...
	 * @var string
	 */
	const META_KEY_FIRST_PAYMENT_STRATEGY = '_fatoripay_subscription_first_payment_strategy';
	 ...
	 *
	 * @param  \stdClass $data Store FatoriPay object.
	 * @return void
	 */
	 ...
	 * Get order meta data.
	 *
	 * @return \stdClass|boolean The FatoriPay payment meta if exists. False, otherwise.
	 */
	...
	/**
	 * Sets the fatoripay subscription id
	 *
	...
	/**
	 * Gets the FatoriPay subscription id
	 *
	 * @return string|false The FatoriPay subscription id if defined. False, otherwise.
	 */
	 ...
	 *
	 * @return \stdClass|boolean The FatoriPay first payment strategy meta if exists. False, otherwise.
	 */
