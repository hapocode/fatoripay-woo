...
<div class="notice notice-error">
	<p>
		<span class="dashicons-before dashicons-dismiss components-dropdown"></span><strong><?php esc_html_e( 'The FatoriPay WooCommerce plugin does not support the auto renewal toggle feature.', 'fatoripay-woo' ); ?></strong>
	<?php
