...
class Card_Security_Code extends Form_Field {
	...
	public function get_type() {
		return 'fatoripay-card-security-code';
	}
	...
	public function get_subfields( $key, $args ) {
		...
		return apply_filters(
			'woocommerce_fatoripay_card_security_code_subfields', array(
	...
	public function invalid_security_code_message() {
		return apply_filters( 'woocommerce_fatoripay_invalid_security_code_message', __( 'Invalid security code.', 'fatoripay-woo' ) );
	}
}
