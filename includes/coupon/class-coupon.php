...
class Coupon {
	...
	public function show_notice_about_supported_coupon_types() {
		...
		?>
		<div class="fatoripay-supported-coupon-types">
			<hr>
			<p>
				...
				<strong>
					...
					echo esc_html( sprintf( __( 'FatoriPay gateway currently supports the following coupon types: %s.', 'fatoripay-woo' ), $subscriptions_helper->get_supported_coupon_types_string() ) );
					?>
				</strong>
			</p>
		</div>
